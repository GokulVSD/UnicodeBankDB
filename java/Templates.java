...
public class Templates {
    static String administrator = "<button onclick=\"login()\" class=\"btn btn-warning\">Reset</button>\n" +
            "<h5 style=\"display: inline-block; vertical-align: middle; margin-left: 25px; margin-right: 25px; margin-top: 28px; font-size: 32px; border: 3px solid #777777; color: #777777; padding-bottom: 6px; padding-top: 3px; padding-left: 8px; padding-right: 8px; border-radius: 20px\">Admin</h5>\n" +
    ...
    static String regular(String custname) {
        return "<button onclick=\"login()\" class=\"btn btn-warning\">Reset</button>\n" +
                ...
                "<button onclick=\"location.href='./'\" class=\"btn btn-warning\">Logout</button>\n" +
                "<div id=\"hideme\"><h5>ID: " + custname +"</h5>" +
                "<button onclick=\'loadCustomerDetails(\"" + custname + "\",\"0\")\'>Start Session</button></div>"+
                "<div id=\"admin-dynamic-1\"></div>\n" +
                "<div id=\"admin-dynamic-2\"></div>\n" +
                "<div id=\"admin-dynamic-3\"></div>\n" +
                "<div id=\"admin-dynamic-4\"></div>\n" +
